...
public class TabGameFragment extends BaseFragment {
	...
	public TabGameFragment() {
		...
		arrayOfFragment[0] = new GameRecomFragment();
		arrayOfFragment[1] = new GameCategoryFragment();
		arrayOfFragment[2] = new GameRankFragment();
		arrayOfFragment[3] = new GameNewFragment();
		this.fragments = arrayOfFragment;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (view == null) {
			...
			initView(view);
			Utils.D("game view == null initView(view)");
		}
	...
	private class MyAdapter extends
		...
		private LayoutInflater inflater = LayoutInflater
				.from(TabGameFragment.this.getActivity());
		private String[] tabNames = { "推荐", "分类", "排行", "新锐" };
		...
		public Fragment getFragmentForPage(int paramInt) {
			return TabGameFragment.this.fragments[paramInt];
		}
