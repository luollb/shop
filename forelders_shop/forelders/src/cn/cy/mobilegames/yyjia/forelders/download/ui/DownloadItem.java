...
/**
 * This class customizes RelativeLayout to directly handle clicks on the left
 * part of the view and treat them at clicks on the checkbox. This makes rapid
 * selection of many items easier. This class also keeps an ID associated with
 * the currently displayed download and notifies a listener upon selection
 * changes with that ID.
 */
public class DownloadItem extends RelativeLayout {
	...
	// public void onDownloadSelectionChanged(long downloadId,
	// boolean isChecked);
	...
	protected void onFinishInflate() {
		...
		mCheckBox = (MyCheckBox) findViewById(R.id.download_checkbox);
	}
	...
	private void toggleCheckMark() {
		mCheckBox.toggle();
		Utils.D(" mDownloadId " + mDownloadId + " -=-check  "
				+ mCheckBox.isChecked());
		mListener
				.onDownloadSelectionChanged(mDownloadId, mCheckBox.isChecked());
	}
}
