...
public class DropDownListView extends ListView implements OnScrollListener {
	...
	/**
	 * set footer progress's drawable bar when loading
	 * 
	 * @param isShowFooterProgressBar
	 */
	public void setFooterIndeterminateDrawable(int resId) {
		footerProgressBar.setIndeterminateDrawable(getResources().getDrawable(
				resId));
	}

	/**
	 * set header progress's drawable bar when loading
	 * 
	 * @param isShowFooterProgressBar
	 */
	public void setHeaderIndeterminateDrawable(int resId) {
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		if (isOnBottomStyle && isAutoLoadOnBottom && hasMore) {
			if (firstVisibleItem > 0 && totalItemCount > 0
				...
				Utils.I(" onBottom " + "firstVisibleItem " + firstVisibleItem
