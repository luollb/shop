...
public class SorBean implements Parcelable {
    private String name;
    private String tag;
    ...
    public static final Creator<SorBean> CREATOR = new Creator<SorBean>() {
        @Override
        public SorBean createFromParcel(Parcel in) {
            return new SorBean(in);
        }

        @Override
        public SorBean[] newArray(int size) {
            return new SorBean[size];
        }
    };
